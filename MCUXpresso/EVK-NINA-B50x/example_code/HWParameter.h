...
typedef PACKED_STRUCT hardwareParameters_tag
{
    ...
    uint8_t xtalCap32K;               /*!< XTAL 32k capacitance value */
    /*@}*/
    ...
    uint8_t type_number[16];      /* u-blox Type number */
    uint8_t serial_number[8];       /* u-blox Serial number */

    uint8_t
             reserved[39]; /*!< reserved for adding field to the structure without changing the Crc field adress location*/
