...
#define BT_CAL_DATA_ANNEX_100_EPA_FEM_MASK_LOW_BYTE 0x00U
#define BT_CAL_DATA_ANNEX_100_LNA_FEM_MASK_LOW_BYTE 0x00U
...
static int PLATFORM_SetBtCalDataAnnex100(void)
{
    ...
    uint8_t params[HCI_CMD_STORE_BT_CAL_DATA_PARAM_ANNEX100_LENGTH] = {
        ...
        0x8FU, //  CheckSum: Annex100 ignores checksum
